...
export type StoryLikeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "storyId" | "createdAt", ExtArgs["result"]["storyLike"]>
...
export interface StoryLikeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const storyLikeWithUserIdOnly = await prisma.storyLike.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StoryLikes and only return the `userId`
   * const storyLikeWithUserIdOnly = await prisma.storyLike.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more StoryLikes and only return the `userId`
   * const storyLikeWithUserIdOnly = await prisma.storyLike.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
